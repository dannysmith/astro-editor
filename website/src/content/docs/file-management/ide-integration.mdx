...
Set your **IDE Command** in the [General preferences](/preferences/#general) (<Kbd mac="Cmd+," windows="Ctrl+," />). This is the command Astro Editor runs to launch your editor. If your editor's command-line launcher is on your `PATH`, the name alone is enough:
...
<Aside type="caution" title="Keep it to a single command">
