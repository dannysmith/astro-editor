...
| Item | Description |
| --- | --- |
| **Title** | Taken from the `title` frontmatter field (or whatever *title* field is configured in the [preferences](/preferences/#frontmatter-mappings)). The filename is shown if none exists. |
