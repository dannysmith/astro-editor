...
When editing an MDX file, <Kbd mac="Cmd+/" windows="Ctrl+/" /> will open the component builder. This shows all the components inside your configured `/components/mdx` directory.
...
1. Press <Kbd mac="Cmd+/" windows="Ctrl+/" /> in any MDX file
...
5. Press <Kbd mac="Cmd+Enter" windows="Ctrl+Enter" /> to insert the component into your document
