...
When you're editing in the main editor, you can quickly preview images by holding <Kbd mac="Opt" windows="Alt" /> and hovering over any image path or URL. A preview will appear in the bottom right corner of the editor.
