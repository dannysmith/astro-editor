...
<Aside>
By default, these images use paths relative to the current file, matching Astro's conventions. If you'd rather use absolute paths from the project root instead (e.g. `/src/assets/thing/image.png`), you can enable this in the [preferences](/preferences/#path-overrides).
</Aside>
