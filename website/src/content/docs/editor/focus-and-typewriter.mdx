...
Typewriter mode keeps the cursor line vertically centred in the editor at all times. As you type or navigate, the viewport scrolls to keep the cursor in the middle of the visible area, much like a real typewriter.

You can toggle it on and off with <Kbd mac="Cmd+Shift+T" windows="Ctrl+Shift+T" /> or the icon in the toolbar.

![The editor with typewriter mode on, keeping the current line centred in the window](../../../assets/typewriter-mode.png)
