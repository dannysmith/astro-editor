...
_Documentation coming soon — inserting links with <Kbd mac="Cmd+K" windows="Ctrl+K" /> and pasting a URL over selected text._

## Clicking Links

_Documentation coming soon — <Kbd mac="Opt" windows="Alt" /> + click to open a link in your browser._
...
**Opening the Content Linker**: Press <Kbd mac="Cmd+Shift+K" windows="Ctrl+Shift+K" /> from the editor, or use the command palette (<Kbd mac="Cmd+P" windows="Ctrl+P" />) and search for "Content Linker".
...
3. Choose what to do with the selected item:
   - **Press <Kbd mac="Enter" windows="Enter" />** to open the file in the editor
   - **Press <Kbd mac="Cmd+Enter" windows="Ctrl+Enter" />** to insert a markdown link at your current cursor position

The dialog footer shows these actions as a reminder: <Kbd mac="Enter" windows="Enter" /> to open, <Kbd mac="Cmd+Enter" windows="Ctrl+Enter" /> to insert a link.
...
1. Open Preferences (<Kbd mac="Cmd+," windows="Ctrl+," />)
