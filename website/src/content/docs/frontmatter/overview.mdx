...
![alt text](../../../assets/frontmatter-sidebar-overview.png)
...
**Primary Method: JSON Schema Files**
...
TODO: describe how fields not present in the schema but are present in the front matter of show what order they come in, etcetera. 
