...
Astro Editor treats a few frontmatter fields specially – both in the frontmatter sidebar and elsewhere. The **title**, **date**, **description**, and **draft** fields can each be remapped per project or per collection in the [Preferences](/preferences/#field-mappings) – the precise override rules are covered in [Overrides](/reference/overrides/).
...
<Aside>
If your posts use a date field that isn't called `date` (such as `pubDate`), set it in the [Preferences](/preferences/#field-mappings) so sorting works as you'd expect.
</Aside>
