...
Astro Editor is an interface for the content in your [Astro](https://astro.build/) project — the [philosophy page](/getting-started/philosophy/) explains why that matters. To properly understand this in practice, it helps to look at a quick example.
...
Given those two content colelctions, Astro Editor will expect your project to look something like this:
...
<CardGrid>
  <LinkCard title="Left Sidebar" href="/file-management/overview/" description="Browse, sort, and filter collections and files." />
  <LinkCard title="Main Editor" href="/editor/overview/" description="The main writing surface." />
  <LinkCard title="Right Sidebar" href="/frontmatter/overview/" description="Edit the file's frontmatter." />
  <Card title="Toolbar">Minimal UI controls.</Card>
</CardGrid>
