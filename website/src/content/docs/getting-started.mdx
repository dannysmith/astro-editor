...
That's the whole setup — Astro Editor works directly with your existing project, so there's nothing extra to configure.

<LinkCard title="Introduction to Astro Editor" href="/getting-started/introduction/" description="A tour of the interface and what Astro Editor needs from your project." />
