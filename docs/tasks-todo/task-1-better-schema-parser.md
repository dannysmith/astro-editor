...
## DEFERRED: ImageField Implementation

**Copy this section to `docs/tasks-todo/task-X-image-field-support.md` when creating follow-up task.**
...
- Image fields render as StringField (text input)
- Users manually type image paths
